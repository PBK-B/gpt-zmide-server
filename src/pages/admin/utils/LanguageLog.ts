 ...
 * @Author: Bin
 * @Date: 2023-04-09
 * @FilePath: /gpt-zmide-server/src/pages/admin/utils/LanguageLog.ts
 */

function extendDefaults(...args: any[]) {
...
function MonacoLanguageLog(monaco: any) {
    ...
    for (let i = 0; i < typeCustomTokenizer.length; i++) {
        try {
            ...
            // console.log("typeCustomTokenizer", typeCustomTokenizer[i].style);
